...
if __name__ == '__main__':
  ...
  print("\r\n /-------------------------------------------------------------/ \r\n")
  header = ["Date-Time",'Pressure (hPa)', 'Temperature (°C)', 'Roll', 'Pitch', 'Yaw ', 'X Acc (g)', 'Y Acc (g)', 'Z Acc (g)', 'Gyro X (°/s)', 'Gyro Y (°/s)', 'Gyro Z (°/s)', 'Mag X (µT)', 'Mag Y (µT)', 'Mag Z (µT)']
  print('Date-Time | Pressure (hPa) | Temperature (°C) | Roll | Pitch | Yaw | X Acc | Y Acc | Z Acc | Gyro X | Gyro Y | Gyro Z | Mag X | Mag Y | Mag Z | ')
  ...
  with open('../IMU_Data/IMU_Data.csv', 'w',encoding='UTF8', newline='') as f:
    ...
    while x<200:
      ...
      vX=Accel[0]/16384*0.1
      #print(Accel[0])
      vY=Accel[1]/16384*0.1
      vZ=(Accel[2]/16384-9.8)*0.1  
      dX=1/2*Accel[0]/16384*(0.1**2)
      dY=1/2*Accel[1]/16384*(0.1**2)
